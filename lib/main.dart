          ...
          child: BonfireWidget(
            ...
            joystick: Joystick(
              ...
              directional: JoystickDirectional(
                color: Colors
                    .white, // if you do not pass  'pathSpriteBackgroundDirectional' or  'pathSpriteKnobDirectional' you can define a color for the directional.
                size: 100, // directional control size
                isFixed:
                    true, // enables directional with dynamic position in relation to the first touch on the screen
              ),
            ),
            overlayBuilderMap: {
